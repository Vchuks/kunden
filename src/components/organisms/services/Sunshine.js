...
const Sunshine = () => {
  return (
    <div className="bg-white pad">
      <Text
        className="solution sun text-xl lg:text-3xl mt-20 w-max lg:ml-auto"
        children="Sunshine Digital Center"
      />
      <div className="flex flex-col lg:flex-row gap-4 items-center mb-28">
        <div className="w-full pt-8 lg:pt-0">
          <Image className="" src={sunpic} />
        </div>
        <div className="w-full lg:ps-8">
          <Text
            className="text-lg text-justify font-light leading-8 py-10 lg:pt-0"
          ...
          />
          <TextLinks to="/book-hall" className="txtpurple  text-lg lg:text-xl font-medium" children="BOOK OUR HALL FOR YOUR EVENTS >" />
        </div>
      </div>
    </div>
  );
