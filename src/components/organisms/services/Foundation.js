...
const Foundation = () => {
  return (
    <div className='pad'>
      <div className='flex flex-col lg:flex-row items-center found-one px-4 py-10 lg:p-16 gap-10 lg:gap-0 mt-14 lg:mt-28'>
        <div className='w-full'>
            <div className='w-20'><Image src={img1} className=""/></div>
      ...
      <div className='flex flex-col lg:flex-row items-center found-two bgpurple px-4 py-10 lg:p-16 mt-10 lg:mt-16 gap-10 lg:gap-0 mb-10'>
        <div className='w-full'>
            <div className='w-20'><Image src={img2} className=""/></div>
