...
const Foundation = () => {
  return (
    <div className='pad'>
      <div className='flex flex-col-reverse lg:flex-row items-center found-one px-4 py-10 lg:p-16 gap-10 lg:gap-0 mt-14 lg:mt-28' data-aos="flip-up"
      ...
      <div className='flex flex-col-reverse lg:flex-row items-center found-two bgpurple px-4 py-10 lg:p-16 mt-10 lg:mt-16 gap-10 lg:gap-0 mb-10' data-aos="flip-up"
          data-aos-duration="2000"
          data-aos-easing="ease-in-out">
        <div className='w-full'>
