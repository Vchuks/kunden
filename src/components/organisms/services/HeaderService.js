...
const HeaderService = () => {
  return (
    <>
    <div className="text-center lg:text-start pad flex flex-col-reverse lg:flex-row gap-4">
      <div className="w-full flex justify-between">
        <Text
          className="lg:w-8/12 lg:text-lg"
      ...
      <div className="w-full ">
        <p className="text-service pt-4 lg:pt-0">
          The <span className="solution">Solution</span> to Digital Technologies
          & Electronic Payments<span className="dot">.</span>
        </p>
      </div>
    </div>
    <div className="lg:ml-auto lg:w-1/2 items-center flex flex-col lg:flex-row px-4 py-4 lg:py-0 gap-4 lg:gap-8">
      <TextLinks to="#" children={<button className="w-56 px-8 py-4 rounded-full bgpurple text-white">Get Started</button>} />
      <TextLinks to="#" children={<button className=" underline font-medium">Contact Us</button>} />
    </div>
    </>
  );
};
